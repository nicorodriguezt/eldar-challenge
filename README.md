...
El repositorio contiene dos proyectos separados que requieren que se ejecute npm install en cada uno de ellos:
 ...
 El proyecto de angular consta de un login con usuario y contraseña, que da acceso a una lista de productos. Una vez en la lista de productos dependiendo del rol del usuario se podrá acceder a la creación y edición de productos.
